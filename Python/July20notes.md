...
### 2. List  
**Definition:**  
A list is an ordered and mutable collection of elements. Elements can be added, removed, or changed.

### 3. Tuple  
**Definition:**  
A tuple is an ordered but immutable collection. Once created, it cannot be changed.
...
### 5. Dictionary  
**Definition:**  
A dictionary stores data in key-value pairs. Each value is accessed using a key.
